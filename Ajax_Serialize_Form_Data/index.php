...
<head>
    ...
    <title>Ajax_Serialize_Form_Data</title>
</head>
<body>
    
    <div id="main">
        <div id="header">
            <h1>PHP and Ajax_Serialize_Form_Data</h1>
        </div>
            ...
            $('#submit').click(function(){
                ...
                if(name == "" || age == "" || !$('input:radio[name=gender]').is(':checked')){
                    ...
                    $.ajax({
                        ...
                        beforeSend : function(){
                            $('#response').fadeIn();
                            $('#response').removeClass('successMsg errorMsg').addClass('processMsg').html('Loading response...');
                        } ,
